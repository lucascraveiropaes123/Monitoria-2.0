...
public class AtualizarProfessor extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProfessorDAO bDAO = new ProfessorDAO();
            Professor professor = new Professor();
            
            Professor professorVelho = (Professor)session.getAttribute("ProfessorVelho");
            ...
            bDAO.updateProfessor(professorVelho.getId_professor(), professor);
