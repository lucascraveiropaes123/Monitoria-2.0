...
public class OpcoesProfessor extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer id = Integer.parseInt(request.getParameter("professor"));
            Professor professor = pDAO.getProfessor(id);

            String opcao = request.getParameter("opcao");
            
            if(opcao.equalsIgnoreCase("Atualizar"))
            {
                session.setAttribute("ProfessorVelho", professor);

                RequestDispatcher view = request.getRequestDispatcher("AtualizarProfessor.jsp");
