...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <form role="form" action="OpcoesProfessor" id="Atualizar" style="margin-top: 1em">
                    <div class="row">
                        <div class="col-md-12">
                            <label>Selecione o professor e o que deseja fazer:</label>
                            <div class="form-group">
                                <%for (Professor professor : professores)
                                {%>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="professor" id="optionsRadios1" value="<%=professor.getId_professor()%>"/><%=professor.getNome_completo()%>
                                        </label>
                                    </div>
                                <%}%>
                            </div>
