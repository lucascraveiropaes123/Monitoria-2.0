...
<%
    ...
    Disciplina disciplina = (Disciplina)session.getAttribute("DisciplinaVelha");
%>
            ...
            <div id="page-inner">
                ...
                <div class="row" style="margin-top: 2em">
                    <div class="col-md-3 col-sm-6 col-xs-6">           
                        <form role="form" action="AtualizarDisciplina">
                            <div class="form-group">
                                <label>Nome: </label>
                                <input class="form-control" name="nome" placeholder="<%=disciplina.getNome()%>" />
