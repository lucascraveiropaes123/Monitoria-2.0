...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <form role="form" action="OpcoesDisciplina" id="Atualizar" style="margin-top: 1em">
                    <div class="row">
                        <div class="col-md-12">
                            <label>Selecione a disciplina e o que deseja fazer:</label>
                            <div class="form-group">
                                <%for (Disciplina disciplina : disciplinas)
                                {%>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="disciplina" id="optionsRadios1" value="<%=disciplina.getKey_disciplina()%>"/><%=disciplina.getNome()%>
                                        </label>
                                    </div>
                                <%}%>
                            </div>
