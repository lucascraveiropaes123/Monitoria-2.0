...
<%
    ...
    Professor professor = (Professor)session.getAttribute("ProfessorVelho");
%>
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Cadastro de Matérias</h2>   
                        <h5>Digite as infomações necessárias para a atualização dos dados do professor</h5>
                    </div>
                </div>    <div class="row" style="margin-top: 2em">
                    <div class="col-md-3 col-sm-6 col-xs-6">           
                        <form role="form" action="AtualizarProfessor">
                            <div class="form-group">
                                <label style="margin-top: 1em;">Primeiro Nome: </label>
                                <input class="form-control" name="primeiroNome" value="<%=professor.getPrimeiro_nome()%>" />
                                ...
                                <input class="form-control" name="login" value="<%=professor.getLogin()%>" />
                                
                                <label style="margin-top: 1em;">Senha: </label>
                                <input class="form-control" type="password" name="senha" value="<%=professor.getSenha()%>" />
