                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a class="active-menu" href="#">Cadastrar</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
            ...
            <div id="page-inner">
                ...
                <div class="row" style="margin-top: 2em">
                    <div class="col-md-3 col-sm-6 col-xs-6">           
                        <form role="form" action="CadastroProfessor">
                            <div class="form-group">
                                <label>Primeiro Nome: </label>
                                <input class="form-control" name="primeiroNome" placeholder="Digite o primeiro nome do professor" />
                                
                                <label>Sobrenome: </label>
                                <input class="form-control" name="sobrenome" placeholder="Digite o sobrenome do professor" />
                                
                                <label>Matéria: </label>
                                
                                <select name="materia">
                                    <option style="color:black" value="-">Escolha a matéria relacionada à esse professor</option>
                                ...
                                <label>Login: </label>
                                <input class="form-control" name="login" placeholder="Digite o nome do professor" />
                                
                                <label>Senha: </label>
                                <input class="form-control" type="password" name="senha" placeholder="Digite o nome do professor" />
